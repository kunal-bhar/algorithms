...
class DecisionTree:
    ...
    def __init__(self, min_samples_to_continue= 2, max_depth= 10, n_feats= None):
    ...
    def _grow_tree(self, X, y, depth= 0):
        ...
        if (
            ...
            or n_lables== 1
            or n_samples< self.min_samples_to_continue
            ):
...
if __name__== '__main__':
    ...
    print("Accuracy for our Decision Tree Classifier:", acc)   
